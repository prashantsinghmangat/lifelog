...
// A stand-in project ref. `tokenFrom` reads the token out of whatever URL it is
// handed, so nothing here depends on a real one — and pinning a live project's
// endpoint in a public repository hands it to anyone reading the tests.
const REF = 'https://project.supabase.co/auth/v1/verify'
